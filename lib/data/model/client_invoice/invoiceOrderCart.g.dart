...
part of 'invoiceOrderCart.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class InvoiceOrderCartAdapter extends TypeAdapter<InvoiceOrderCart> {
  @override
  final int typeId = 2;

  @override
  InvoiceOrderCart read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return InvoiceOrderCart(
      id: fields[0] as int?,
  ...
  @override
  void write(BinaryWriter writer, InvoiceOrderCart obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is InvoiceOrderCartAdapter &&
