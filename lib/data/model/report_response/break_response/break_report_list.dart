...
BreakReportListResponse breakReportListResponseFromJson(String str) => BreakReportListResponse.fromJson(json.decode(str));

String breakReportListResponseToJson(BreakReportListResponse data) => json.encode(data.toJson());

class BreakReportListResponse {
  BreakReportListResponse({
    this.result,
    this.message,
    this.data,
  });
  ...
  factory BreakReportListResponse.fromJson(Map<String, dynamic> json) => BreakReportListResponse(
    result: json["result"],
