...
import 'package:crm_demo/data/model/auth_response/response_change_password_profile.dart';
import 'package:crm_demo/data/model/auth_response/response_change_passwrod.dart';
...
class AuthRepository {
  ...
  static Future<ApiResponse<ResponseLogin>> getLogin(
    ...
    try {
      ...
      var response = await ApiService.getDio()!.post("/Welcome/userLogin", data: bodyLogin);
      EasyLoading.dismiss();
