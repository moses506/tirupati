...
import 'package:crm_demo/data/model/auth_response/response_verification_code.dart';
...
import 'package:crm_demo/data/model/response_approval_or_reject.dart';
...
import 'package:crm_demo/data/model/response_change_status.dart';
import 'package:crm_demo/data/model/response_check_in.dart';
import 'package:crm_demo/data/model/response_check_out.dart';
import 'package:crm_demo/data/model/response_clear_notification.dart';
import 'package:crm_demo/data/model/response_create_appreciate.dart';
import 'package:crm_demo/data/model/response_create_leave_request.dart';
import 'package:crm_demo/data/model/response_create_visit.dart';
import 'package:crm_demo/data/model/response_create_visit_note.dart';
import 'package:crm_demo/data/model/response_image_upload_visit.dart';
...
import 'package:crm_demo/data/model/response_notice_create.dart';
...
import 'package:crm_demo/data/model/response_support_create.dart';
...
class Repository {
  ...
  static Future<ApiResponse<ResponseAllUser>> getAllUserData(
    ...
    try {
      EasyLoading.show(status: 'loading...');
      if (kDebugMode) {
        print("/app/c?keywords=$search");
      }
      var response = await ApiService.getDio()!
          .get("/app/get-all-users?designation_id=${designationId ?? ""}?keywords=$search");
      EasyLoading.dismiss();
      if (response.statusCode == 200) {
        if (kDebugMode) {
          print(response.data);
  ...
  static Future<ApiResponse<PhonebookDetailsModel>> getPhonebookDetails(
    ...
    try {
      EasyLoading.show(status: 'loading...');
      if (kDebugMode) {
        print("/app/get-all-users?designation_id=$id");
      }
  ...
  static Future<ApiResponse<ResponseBaseSetting>> baseSettingApi() async {
    try {
      // EasyLoading.show(status: 'loading...');
      var response = await ApiService.getDio()!.get("/app/base-settings");
      // EasyLoading.dismiss();
      if (response.statusCode == 200) {
        if (kDebugMode) {
          print(response.data);
  ...
  static Future<ApiResponse<ResponseSupportCreate>> supportCreateApi(
    ...
    try {
      EasyLoading.show(status: 'loading...');
      var response =
      await ApiService.getDio()!.post("/support-ticket/add", data: fromData);
      EasyLoading.dismiss();
      if (response.statusCode == 200) {
        if (kDebugMode) {
          print(response.data);
