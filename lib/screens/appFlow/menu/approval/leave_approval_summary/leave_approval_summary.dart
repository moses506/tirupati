...
import 'package:crm_demo/screens/appFlow/menu/approval/leave_approval_summary/leave_approval_summary_provider.dart';
import 'package:crm_demo/utils/nav_utail.dart';
import 'package:crm_demo/utils/res.dart';
import 'package:provider/provider.dart';
import 'package:syncfusion_flutter_gauges/gauges.dart';
import '../leave_summary_details/leave_summary_details.dart';

class LeaveApprovalSummary extends StatelessWidget {
  final int? userId;

  const LeaveApprovalSummary({Key? key, this.userId}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => LeaveApprovalSummaryProvider(userId),
      child: Consumer<LeaveApprovalSummaryProvider>(
        builder: (context, provider, _) {
          return Scaffold(
            appBar: AppBar(title: Text(tr("Employee Leave History"))),
            body: Column(
              ...
              children: [
                ...
                Visibility(
                  visible: provider.responseLeaveSummary?.data?.availableLeave
                          ?.isNotEmpty ??
                      false,
                  child: SizedBox(
                    height: 100,
  ...
  InkWell currentDate(
      LeaveApprovalSummaryProvider provider, BuildContext context) {
    return InkWell(
      onTap: () {
