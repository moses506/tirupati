...
class ClientInvoiceDropDownAndFormList extends StatelessWidget {
  final ClientCreateInvoiceProvider provider;

  const ClientInvoiceDropDownAndFormList({
          ...
          const SizedBox(height: 8,),
           Row(
            children: [
              ...
              Consumer<InvoiceOrderService>(
                builder: (context, invoiceCartProvider, _) {
                  return Expanded(
                    child: CustomDropdown<ClientInvoiceWarehouse>(
                      ...
                      onChanged: (ClientInvoiceWarehouse? newValue) {
                        ...
                        invoiceCartProvider.clearProductFromCart();
                      },
