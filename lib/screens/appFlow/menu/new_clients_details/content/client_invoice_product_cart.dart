...
class ClientInvoiceProductCart extends StatelessWidget {
  CartService cartProvider;
  ClientCreateInvoiceProvider? provider;
  int productId;
  ClientInvoiceProductCart({
    super.key, required this.productId, required this.cartProvider, required this.provider
  });
