...
class ScheduleOverviewSearchContainer extends StatelessWidget {
  ScheduleOverProvider? provider;
  ScheduleOverviewSearchContainer({
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text(textAlign: TextAlign.center, "sorted schedule overview by selected information", style: TextStyle(color: AppColors.colorPrimary),),
          )
        ],
      ),
    );
