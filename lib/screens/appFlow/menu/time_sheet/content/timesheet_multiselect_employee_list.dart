...
class TimesheetMultiselectEmployeeList extends StatelessWidget {
  MonthlyOverviewProvider provider;
  TimesheetMultiselectEmployeeList({super.key, required this.provider});
  ...
  void showEmployeeMultiSelectDialog(BuildContext context, List<TimesheetEmployee> items, MonthlyOverviewProvider provider) {
    showDialog(
      context: context,
